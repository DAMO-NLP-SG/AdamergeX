...
def main(argv):
    ...
    dataset = list(load_dataset("xquad", 'xquad.'+argv[0])["validation"])
    try:
    ...
    with open('./Results_Llama2_XLT.txt', 'a', encoding='utf-8') as file:
        file.write('\n')
        file.write('XQUAD_' + language_name + '_' + str(argv[1]).replace('_Wiki', '') + '\n' + str(correct/all_index))
        file.write('\n')
